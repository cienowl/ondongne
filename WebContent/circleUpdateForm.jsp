                ...
                <form action="postupdate.circle" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" name="event_date" value="<%=event_date %>" id="event_date"/>
                        	<small id="eventdateHelp" class="form-text text-danger"></small>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="circle_deadline">모집마감일</label>
                            <input type="date" class="form-control" name="end_date" value="<%=end_date %>" id="end_date"/>
