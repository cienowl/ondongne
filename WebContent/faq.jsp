                ...
                <section class="dark-grey-text">
                    ...
                    <div class="row text-center text-md-left">
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">동네 소모임은 어떻게 만드나요?</h5>
                            <p class="text-muted">좌측 상단의 동네 소모임으로 이동하여 소모임 글쓰기를 클릭 후 모임이름, 관심사, 설명, 지역 등을 고르신 후 모임만들기를 누르시면 됩니다.</p>
                        </div>

                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">모임 가입은 어떻게 하나요?</h5>
                        ...
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">동네 장터의 거래 및 환불은 어떻게 이루어지나요?</h5>
                        ...
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">가격 제안이 뭐에요?</h5>
                        ...
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">게시글들은 어떻게 수정하나요?</h5>
                        ...
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">회원정보 수정 및 탈퇴는 어떻게 하나요?</h5>
...
탈퇴는 [마이페이지 > 탈퇴하기] 에서 탈퇴할 수 있어요. 탈퇴하면 모든 게시글과 채팅 내용이 삭제되고 복구할 수 없으니 신중하게 탈퇴해 주세요.</p>
                        ...
                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">관심 지역 변경은 어떻게 하나요?</h5>
                            <p class="text-muted">[마이페이지 > 관심지역 설정하기] 에서 변경가능합니다. 관심지역은 3곳까지 설정 가능하며, 동네도 변경/추가해 보세요.</p>
                        </div>

                        <div class="col-md-6 mb-4">
                            <h5 class="font-weight-normal mb-3">ON동네에 대해 알려주세요.</h5>
