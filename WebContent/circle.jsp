	...
	<body>
		<header>
           ...
           <%
            ...
            %>
            <section class="wow fadeIn" style="background-image: url('img/circle/circleIndex.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
