...
<html>
    ...
    <body>
        ...
        <script>
            ...
            var defaultRegion = '강남구';  //default 값
            ...
            $(document).ready(function() {
                ...
                //검색시 사용
                var searchWord = null;
                var searchWordPrev = defaultRegion;
                $("#searchBtn").on('click', function(){
                    searchWordPrev = searchWord;
                    ...
                    if (searchWord != "" && searchWord != searchWordPrev) {
                        $('#cardContents').empty();
                        $('#modalContents').empty();
                        //TODO: 지도 위치이동
                        page = 0;
        ...
        <script>
            // DB내용 가져오는 Ajax
            // TODO: region을 keyword로 고치고 검색어로 변경
