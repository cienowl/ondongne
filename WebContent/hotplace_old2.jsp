...
<%
	...
	String sessionRegion1 = (String) session.getAttribute("region1");
	String sessionRegion2 = (String) session.getAttribute("region2");
	String sessionRegion3 = (String) session.getAttribute("region3");
...
<html>
    ...
    <body>
                ...
                <div class="map_wrap mx-auto">
                    ...
                    <div id="menu_wrap">
                        <form class="md-form input-group" onsubmit="searchPlaces(); return false;">
                            <% if (sessionEmail != null) { %>
                            <input type="text" class="form-control" id="keyword" name="keyword" value="<%= sessionRegion1 %>" size="12" placeholder="검색어 입력" aria-label="검색어 입력창" aria-describedby="searchBtn">
                            <% } else { %>
                            <input type="text" class="form-control" id="keyword" name="keyword" value="강남구 맛집" size="12" placeholder="검색어 입력" aria-label="검색어 입력창" aria-describedby="searchBtn">
                            <% } %>
        ...
        <script>
            ...
            //로그인시 세션 지역구 저장
            var sessionRegion1 = '<%= sessionRegion1 %>';
            var sessionRegion2 = '<%= sessionRegion2 %>';
            var sessionRegion3 = '<%= sessionRegion3 %>';
        </script>
